...
/**
 * Tactical Starting / Booting Animation for VaaniSetu Receiver App.
 */
@SuppressLint("CustomSplashScreen")
class ReceiverSplashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            delay(500)
            tvTicker?.text = "MONITORING 433 MHz MESH FREQUENCIES..."
            delay(600)
            tvTicker?.text = "CH 08 LOCKED [433.750 MHz] • RECEIVER ONLINE"
            delay(700)
            navigateToMain()
        }
    ...
    private fun navigateToMain() {
        ...
        val intent = Intent(this, ReceiverStationActivity::class.java)
