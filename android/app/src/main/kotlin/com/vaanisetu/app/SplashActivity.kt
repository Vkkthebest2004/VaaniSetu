...
/**
 * High-tech Tactical Starting / Booting Animation Activity.
 *
 * Displays expanding acoustic radar waves, neural model boot sequences,
 * and frequency locking before transitioning seamlessly into the walkie-talkie.
 */
...
class SplashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            ...
            delay(600)
            tvTicker.text = "CH 08 LOCKED [433.750 MHz] • SEC-L3 READY"
            delay(700)
            navigateToMain()
        }
