...
PAGES_DIR = PROJECT_ROOT / "frontend" / "web" / "pages"
STATIC_DIR = PROJECT_ROOT / "frontend" / "web" / "static"

if not PAGES_DIR.exists():
    PAGES_DIR = PROJECT_ROOT / "web_walkie_talkie"
if not STATIC_DIR.exists():
    STATIC_DIR = PROJECT_ROOT / "web_walkie_talkie"
